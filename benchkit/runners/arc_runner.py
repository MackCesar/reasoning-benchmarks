...
from benchkit.datasets import load_arc
...
def main():
    ...
    examples: List[Dict] = load_arc(split=args.split, max_samples=args.max_samples)
    ...
    out = args.out or f"results/arc_{args.engine}_{args.prompt_style}_{now_ts()}.jsonl"
    save_jsonl(out, rows)
